---
title: Worker Pools
description: Run concurrent work safely with pre-warmed agent pools
---

Run concurrent work safely without melting the BEAM.
...
- [Configuration](/operations/configuration) — Instance setup and pool configuration
