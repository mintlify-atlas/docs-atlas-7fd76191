---
title: Scheduling
description: Delayed and recurring work with declarative schedules and dynamic cron jobs
---
...
- Use declarative `schedules:` for compile-time known recurring work
- Use `Directive.schedule/2` for one-time delays
- Use `Directive.cron/3` for dynamic recurring jobs
- All scheduling is timer-based and non-persistent
- Missed runs are not caught up
- Use idempotency patterns (dedupe keys, last-run timestamps) for reliability

## Next Steps

- [Multi-Agent Patterns](/orchestration/multi-agent) - Parent-child hierarchies
- [Coordination Primitives](/orchestration/coordination) - Event-driven waiting
