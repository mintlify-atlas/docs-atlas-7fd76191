...
description: List agents, actions, and sensors to build tooling around Jido
---

Jido's Discovery system provides a fast, cached catalog of all registered components in your application. Use it to build admin dashboards, generate documentation, or query system capabilities at runtime.
...
<CardGroup cols={2}>
  <Card title="Actions" icon="bolt" href="/guides/actions">
    Implement actions that appear in discovery
  </Card>
  <Card title="Sensors" icon="radar" href="/guides/sensors">
    Create sensors that get indexed
  </Card>
  <Card title="Plugins" icon="puzzle-piece" href="/guides/plugins">
    Package capabilities as discoverable plugins
  </Card>
  <Card title="Testing" icon="flask" href="/guides/testing">
    Test your discovery integration
  </Card>
</CardGroup>
