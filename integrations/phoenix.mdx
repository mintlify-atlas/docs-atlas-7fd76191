...
description: Run Jido agents inside Phoenix applications with LiveView and real-time updates
---

Integrate Jido agents with Phoenix controllers, LiveView, and PubSub for real-time UI updates.
...
- [Signals](/concepts/signals) - Signal routing and creation
- [Actions](/concepts/actions) - Building custom actions
- [Agent Runtime](/guides/runtime) - AgentServer lifecycle and parent-child hierarchies
