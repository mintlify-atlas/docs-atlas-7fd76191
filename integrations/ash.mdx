---
title: Ash Framework Integration
description: Trigger Jido agents from Ash actions and resources
---
...
- [Signals](/concepts/signals) - Signal routing in Jido
- [Actions](/concepts/actions) - Implementing custom Jido actions
